...
public class BasedbApp {
    public static void main(String[] args) throws Exception {
       ...
       //TODO 3.从kafka ods_base_db_m 读取数据
       ...
       FlinkKafkaConsumer<String> kafkaSource = MyKafkaUtil.getKafkaConsumer(topic, groupId);
        ...
        DebeziumSourceFunction<String> sourceFunction = MySQLSource.<String>builder()
                ...
                .build();
        //TODO 6.2 将DebeziumSourceFunction对象添加至数据源构建流对象
        DataStreamSource<String> tableProcessDS = env.addSource(sourceFunction);

        //TODO 6.3 创建mapstate描述符  广播状态必须是map结构
      ...
      /*  realDS.print("事实表");
        ...
        //TODO 9.不同的维度数据写到phoenix不同的表中需要自定义sinkFunction
        dimDS.addSink(new DimSink());

        //TODO 10.不同的事实数据写到kafka不同的主题中 需要自定义KafkaSerializationSchema<T>对象 重写serialize方法生成produceRecord
        realDS.addSink(
